...
(E2.prototype = new b()).isPureReactComponent = true, E2.prototype.shouldComponentUpdate = function(n, t2) {
  return C2(this.props, n) || C2(this.state, t2);
};
var x2 = l.__b;
l.__b = function(n) {
  ...
  "string" == typeof n.type && function(n2) {
    ...
    for (var o2 in t2) {
      ...
      if (!("value" === o2 && "defaultValue" in t2 && null == i2 || Y && "children" === o2 && "noscript" === e2 || "class" === o2 || "className" === o2)) {
        ...
        "defaultValue" === o2 && "value" in t2 && null == t2.value ? o2 = "value" : "download" === o2 && true === i2 ? i2 = "" : "translate" === l3 && "no" === i2 ? i2 = false : "ondoubleclick" === l3 ? o2 = "ondblclick" : "onchange" !== l3 || "input" !== e2 && "textarea" !== e2 || $(t2.type) ? "onfocus" === l3 ? o2 = "onfocusin" : "onblur" === l3 ? o2 = "onfocusout" : H2.test(o2) ? o2 = l3 : -1 === e2.indexOf("-") && B3.test(o2) ? o2 = o2.replace(Z, "-$&").toLowerCase() : null === i2 && (i2 = void 0) : l3 = o2 = "oninput", "oninput" === l3 && u2[o2 = l3] && (o2 = "oninputCapture"), u2[o2] = i2;
      }
    }
...
var FormikContext = G(void 0);
FormikContext.displayName = "FormikContext";
var FormikProvider = FormikContext.Provider;
var FormikConsumer = FormikContext.Consumer;
function useFormikContext() {
  var formik = P(FormikContext);
  ...
  for (var _i = 0, _Object$keys = Object.keys(object); _i < _Object$keys.length; _i++) {
    ...
    if (isObject2(val)) {
      if (!visited.get(val)) {
        ...
        response[k3] = Array.isArray(val) ? [] : {};
        setNestedObjectValues(val, value, visited, response[k3]);
      }
    } else {
      response[k3] = value;
    }
...
function useFormik(_ref) {
  ...
  var initialValues = F(props.initialValues);
  var initialErrors = F(props.initialErrors || emptyErrors);
  var initialTouched = F(props.initialTouched || emptyTouched);
  var initialStatus = F(props.initialStatus);
  ...
  var _React$useState = p(0), setIteration = _React$useState[1];
  var stateRef = F({
  ...
  var dispatch = x(function(action) {
    var prev = stateRef.current;
    stateRef.current = formikReducer(prev, action);
    if (prev !== stateRef.current)
      setIteration(function(x3) {
        return x3 + 1;
      });
  }, []);
  var runValidateHandler = x(function(values, field) {
  ...
  var runValidationSchema = x(function(values, field) {
  ...
  var runSingleFieldLevelValidation = x(function(field, value) {
    return new Promise(function(resolve) {
      return resolve(fieldRegistry.current[field].validate(value));
    });
  }, []);
  var runFieldLevelValidations = x(function(values) {
    var fieldKeysWithValidation = Object.keys(fieldRegistry.current).filter(function(f2) {
      return isFunction2(fieldRegistry.current[f2].validate);
    });
  ...
  var runAllValidations = x(function(values) {
  ...
  var resetForm = x(function(nextState) {
  ...
  var registerField = x(function(name, _ref3) {
    var validate = _ref3.validate;
    fieldRegistry.current[name] = {
      validate
    };
  }, []);
  var unregisterField = x(function(name) {
  ...
  var setErrors = x(function(errors) {
    dispatch({
      type: "SET_ERRORS",
      payload: errors
    });
  ...
  var setFieldError = x(function(field, value) {
    dispatch({
      type: "SET_FIELD_ERROR",
      payload: {
        field,
  ...
  var executeChange = x(function(eventOrTextValue, maybePath) {
    var field = maybePath;
  ...
  var executeBlur = x(function(e2, path) {
    if (e2.persist) {
      e2.persist();
    }
  ...
  var setFormikState = x(function(stateOrCb) {
  ...
  var setStatus = x(function(status) {
    dispatch({
      type: "SET_STATUS",
      payload: status
    });
  }, []);
  var setSubmitting = x(function(isSubmitting) {
    dispatch({
  ...
  var getFieldMeta = x(function(name) {
    return {
  ...
  var getFieldHelpers = x(function(name) {
    return {
  ...
  var getFieldProps = x(function(nameOrOptions) {
...
function Formik(props) {
  ...
  return y(FormikProvider, {
    value: formikbag
  }, component ? y(component, formikbag) : render ? render(formikbag) : children ? isFunction2(children) ? children(formikbag) : !isEmptyChildren(children) ? A2.only(children) : null : null);
}
...
function arrayMerge(target, source, options) {
  ...
  source.forEach(function merge(e2, i2) {
    if (typeof destination[i2] === "undefined") {
      ...
      destination[i2] = shouldClone ? es_default(Array.isArray(e2) ? [] : {}, e2, options) : e2;
    } else if (options.isMergeableObject(e2)) {
      destination[i2] = es_default(target[i2], e2, options);
...
var useIsomorphicLayoutEffect = typeof window !== "undefined" && typeof window.document !== "undefined" && typeof window.document.createElement !== "undefined" ? A : _;
...
function Field(_ref) {
  ...
  if (typeof asElement === "string") {
    ...
    return y(asElement, _extends({
      ref: _innerRef
    }, field, _rest, {
      className
    }), children);
  }
  return y(asElement, _extends({}, field, props, {
    className
  }), children);
}
var Form = N(function(props, ref) {
  var action = props.action, rest = _objectWithoutPropertiesLoose(props, ["action"]);
  var _action = action != null ? action : "#";
  var _useFormikContext = useFormikContext(), handleReset = _useFormikContext.handleReset, handleSubmit = _useFormikContext.handleSubmit;
  return y("form", _extends({
...
function withFormik(_ref) {
  var _ref$mapPropsToValues = _ref.mapPropsToValues, mapPropsToValues = _ref$mapPropsToValues === void 0 ? function(vanillaProps) {
    var val = {};
    for (var k3 in vanillaProps) {
      if (vanillaProps.hasOwnProperty(k3) && typeof vanillaProps[k3] !== "function") {
        val[k3] = vanillaProps[k3];
      }
    }
    return val;
  ...
  return function createFormik(Component$1) {
    ...
    var C3 = function(_React$Component) {
      _inheritsLoose(C4, _React$Component);
      function C4() {
        var _this;
        for (var _len = arguments.length, args = new Array(_len), _key = 0; _key < _len; _key++) {
          args[_key] = arguments[_key];
        ...
        _this.renderFormComponent = function(formikProps) {
          return y(Component$1, _extends({}, _this.props, formikProps));
        };
        return _this;
      }
      ...
      _proto.render = function render() {
        ...
        return y(Formik, _extends({}, props, config, {
    ...
    C3.displayName = "WithFormik(" + componentDisplayName + ")";
...
function connect(Comp) {
  var C3 = function C4(props) {
    return y(FormikConsumer, null, function(formik) {
      ...
      return y(Comp, _extends({}, props, {
        formik
      }));
    });
  };
  var componentDisplayName = Comp.displayName || Comp.name || Comp.constructor && Comp.constructor.name || "Component";
  C3.WrappedComponent = Comp;
  C3.displayName = "FormikConnect(" + componentDisplayName + ")";
  return (0, import_hoist_non_react_statics.default)(
    C3,
    Comp
    // cast type to ComponentClass (even if SFC)
...
var FieldArrayInner = function(_React$Component) {
  ...
  _proto.render = function render() {
    ...
    return component ? y(component, props) : render2 ? render2(props) : children ? typeof children === "function" ? children(props) : !isEmptyChildren(children) ? A2.only(children) : null : null;
  };
...
var ErrorMessageImpl = function(_React$Component) {
  ...
  _proto.render = function render() {
    ...
    return !!touch && !!error ? render2 ? isFunction2(render2) ? render2(error) : null : children ? isFunction2(children) ? children(error) : null : component ? y(component, rest, error) : error : null;
  };
...
var FastFieldInner = function(_React$Component) {
  ...
  _proto.render = function render() {
    ...
    return y(asElement, _extends({}, field, props), children);
  };
